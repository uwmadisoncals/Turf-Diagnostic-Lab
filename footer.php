...
<!-- Display accessibility link and copyright info -->
<div style="float: left; margin-left: auto; margin-right: auto; width: 64%; ">		
	...
	<span class="feedback-text">Accessibility questions: Click <a href="mailto:hockmeyer@wisc.edu">here</a> to send an email.</span> <br /><br />
